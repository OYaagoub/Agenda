...
<head>
    ...
    <title>Agenda</title>
    <link rel="stylesheet" href="app/resources/css/dashboard1.css">
</head>
...
<body>
    ...
    <div id="form">
        ...
        <input type="time" name="" id="time" style="padding:10px">
        <input type="text" id="title" placeholder="Tiltulo">
        <!-- <input type="text" id="descripcion" placeholder="Descripcion"> -->
        <textarea name="" id="description" cols="30" rows="10" placeholder="Descripcion"></textarea>
        <img id="close" src="app/resources/icon/close.png" alt="">
        <div>

            <button id="btn_insert" >Agregar</button>
...
<script src="app/resources/js/openInsert.js"></script>
<script src="app/resources/js/insertdata.js"></script>
</html>